...
const DebtRelief = () => {
  const processSteps = [
    {
      ...
      description:
        "We swiftly identify and engage with prospective buyers when they are in the actual process of searching for debt relief solutions online. From there, we connect with them and evaluate their debt relief needs.",
    },
    {
      icon: CheckCircle,
      title: "We qualify the lead",
      description:
        "We then transfer the lead to our highly experienced in-house team that verifies the prospect's information and intent to seek debt relief services. This process is done using our advanced routing technology.",
    },
    {
      icon: TrendingUp,
  ...
  const benefits = [
    {
      ...
      description:
        "Connect with motivated prospects actively searching for debt relief solutions.",
    },
    {
      icon: Users,
      title: "Scale & Volume",
  ...
  const stats = [
    ...
    { number: "50+", label: "Debt Relief Partners" },
        ...
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-hero-gradient">
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-foreground mb-6 leading-tight">
              Reach Motivated Debt Relief Clients{" "}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-8">
                Data Driven Digital Distribution for the Debt Relief Industry
              </h2>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-heading font-bold text-foreground mb-6">
                Why Choose Our Debt Relief Lead Generation?
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                We deliver high-quality, verified leads that convert into
                profitable debt relief clients for your business.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <Card className="max-w-4xl mx-auto p-12 text-center bg-gradient-to-r from-surface-elevated to-surface-subtle border-accent/20">
              ...
              <h2 className="text-3xl font-heading font-bold text-foreground mb-6">
                Ready to Scale Your Debt Relief Business?
              </h2>
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join hundreds of debt relief professionals who trust Norther
                Leads Media to deliver high-quality leads and drive sustainable
